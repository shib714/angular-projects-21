...
export class ContactsService {
  ...
  private loadSampleData(): void {
    const sampleContacts: ContactModel[] = [
      {
        id: '1',
        firstName: 'John',
        lastName: 'Doe',
  ...
  addContact(contact: Omit<ContactModel, 'id' | 'createdAt' | 'updatedAt'>): void {
  ...
  updateContact(id: string, updates: Partial<Omit<ContactModel, 'id' | 'createdAt'>>): void {
